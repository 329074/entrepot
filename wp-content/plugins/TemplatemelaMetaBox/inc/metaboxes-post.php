...
$TM_META_BOXES[] = array(
	...
	'title' 	=> esc_html__('TM - Short Description', 'shoptown'),
	'pages' 	=> array( 'post' ),
	'context' 	=> 'side',
	'priority' 	=> 'low',
	'local_images' => true,
...
$TM_META_BOXES[] = array(
	'id'		=> 'tm_posts_options',
	'title' 	=> esc_html__('TM - Post Options', 'shoptown'),
	'pages' 	=> array( 'post' ),
	'context' 	=> 'side',
	'priority' 	=> 'low',
	'local_images' => true,
	'fields' 	=> array(
		...
		array(
			'name'    		=> esc_html__('Show Related Posts on single post:', 'shoptown'),
		...
		array(
			'name'    		=> esc_html__('Show Author Info on single post:', 'shoptown'),
...
$TM_META_BOXES[] = array(
	...
	'fields' 	=> array(	
		...
		array(
			'name'    		=> esc_html__('Display Options:', 'shoptown'),
			'id'      		=> "{$prefix}display",
			'type'    		=> 'radio',
			'std'			=> 'grid',
			'options'		=> array(
...
$TM_META_BOXES[] = array(
	...
	'title' 	=> esc_html__('TM - Filter Options', 'shoptown'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'side',
	'priority' 	=> 'low',
	'local_images' => true,
