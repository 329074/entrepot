...
class FooterAboutWidget extends WP_Widget
{
    ...
    function form($instance){
		...
		'title'=>'About Us', 
		'description' => 'There are many variations of passages of dont look even slightly believable. Various versions have evolved ation of have evolved have passages.',
