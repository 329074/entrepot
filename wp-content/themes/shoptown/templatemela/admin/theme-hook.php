  ...
  <div id="General">
	...
	if(!isset( $_REQUEST['reset1'] )) {$_REQUEST['reset1']=''; }
      ...
      <div class="main_title">
        <h1>
          <?php esc_html_e('Hook Manager','shoptown');?>
        </h1>
      </div>
      <?php
       $i= 0;
