...
/**
  ...
  */
add_action('delete_attachment', 'shoptown_mr_delete_resized_images');
function shoptown_mr_image_resize($url, $width=null, $height=null, $crop=true, $align='c', $retina=false) {
  global $wpdb;
  // Get common vars
  $args = func_get_args();
  $common = shoptown_mr_common_info($args);
...
function shoptown_mr_common_info($args) {
  // Unpack arguments
...
function shoptown_mr_delete_resized_images($post_id) {
